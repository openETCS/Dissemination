...
\begin{activity}[past]{CENELEC Course}
	...
	\desc{Introduction to the CENELEC standard (EN 50128) which is highly relevant to openETCS.\newline
             \red{@ALL4TEC: Was this workshop open for external people to attend or just an internal event?}}
\end{activity}

\begin{activity}[past]{ERTMSFormalSpecs Workshop}
