...
\begin{activity}[past]{14th IEEE International High Assurance Systems Engineering Symposium (HASE)}
	\entry{Type of Contribution}	{Conference Paper and Talk}
	\entry{Title}	{Incremental symbolic conformance testing from UML MARTE sequence diagrams: railway use case}
	\entry{Author}	{Christophe Gaston (CEA LIST)}
	\entry{Date}		{25-27/10/2012}
	\entry{Location}	{Omaha (USA)}
	\entry{Publisher}	{IEEE}
	\website{http://hase2012.ist.unomaha.edu/}
	\desc{Abstract to follow}
\end{activity}
