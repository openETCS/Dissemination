...
This section describes the project's dissemination strategy for the future including events, conferences, journals and openETCS-specific activities. Please note that the dissemination strategy also comprises the activities listed in Section~\ref{sct:further_activities} including the transparent, publicly observable working strategy on GitHub.
...
\begin{activity}{IEEE International Conference on Software Testing (ICST)}
	%\entry{Interested Partners}{Institut Telecom}
	\entry{Frequency}{annual}
	\entry{Next Event}{Apr. 2015 Graz, Austria}
