...
In this section the past dissemination activities are described.
...
\begin{activity}{safe.tech 2013}
	\entry{Type} {Talk}
	\entry{Title} {Den Vertrauenskrisen unserer  Gesellschaft entgegenwirken!   Ein möglicher Ausweg mit "open Proofs"  am Beispiel openETCS}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB)}
	\entry{Date}		{24-25/4/2013}
	\entry{Location}	{Munich, Germany}
	\desc{The annual safe.tech symposium is organized by T\"UV S\"UD and represents a platform for exchange of experience in the area of safety with focus on the domains aviation, automotive and railway. A special focus of the 2013 symposium was the interdependence of safety and security in such systems, as an incresingly number of safety critical systems are part of distributed system.}
\end{activity}

\begin{activity}{BITKOM Forum Open Source „Take Home Benefits“}
	\entry{Type} {Talk}
	\entry{Title} {openETCS: Unsere Antwort auf die Vertrauenskrisen unserer Zeit}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB)}
	\entry{Date}		{24/6/2013}
	\entry{Location}	{Berlin, Germany}
	\desc{The annual BITKOM OSS symposium is organized by BITKOM, the german federal association for information technology, telecommunications and new media. Here, the openETCS project with focus on the implementation of the "open proofs" concept in an industrial project has been presented.}
\end{activity}

\begin{activity}{DLR Verkehrs-Kolloquium}
	\entry{Type} {Talk}
	\entry{Title} {Mit "open Proofs" das Vertrauen in komplexe sicherheitskritische Systeme stärken: Am Beispiel des internationalen ITEA2-Projektes openETCS}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB)}
	\entry{Date}		{13/8/2013}
	\entry{Location}	{Brunswick, Germany}
	\desc{The monthly colloquium is organized by the german aerospace center (DLR e.V.) and represents a platform for exchange on current research topics in the domains automotive and railway. Here, the openETCS project has been presented with focus on the implementation of the "open proofs" concept in an industrial project.}
\end{activity}
...
\begin{activity}{PolarSys Workshop}
	\entry{Type} {Talk}
	\entry{Title} {openETCS@ITEA2: An Overview}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB)}
	\entry{Date}		{10/2013}
	\entry{Location}	{Ludwigsburg, Germany}
	\desc{The openETCS project has been presented at the public PolarSys workshop, which took place in conjunction with the EclipseCon Europe. The focus of the presentation was on the open source tool chain in an industrial project.}
\end{activity}

\begin{activity}{International Railway Summit 2013}
	\entry{Type} {Talk}
	\entry{Title} {openETCS@ITEA2: An Open Source Software ETCS Project is making Progress}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB)}
	\entry{Date}		{11/2013}
	\entry{Location}	{Berlin, Germany}
	\desc{The openETCS project has been presented at the International Railway Summit in Berlin, Germany. International Railway Summit is a meeting of senior executives representing the world’s key rail operators, rail infrastructure management companies, national and local governments, rolling stock manufacturers and a wide range of solution providers.}
\end{activity}

\begin{activity}{UIC ERTMS Workshop}
	\entry{Type} {Talk}
	\entry{Title} {openETCS@ITEA2: An Open Source Software ETCS Project is making Progress}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB)}
	\entry{Date}		{14/01/2014}
	\entry{Location}	{Paris, France}
	\desc{The openETCS project and its current state has been presented at the UIC ERTMS Workshop in Paris, France.}
\end{activity}

\begin{activity}{Automatisierungssysteme, Assistenzsysteme und eingebettete Systeme für Transportmittel (AAET) 2014}
	\entry{Type} {Talk}
	\entry{Title} {openETCS: Erste Implementation für das “open Proofs”-Konzept}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB)}
	\entry{Date}		{11-13/02/2014}
	\entry{Location}	{Brunswick, Germany}
	\desc{The openETCS project and with focus on the "open proofs" concept has been presented at the AAET 2014.}
\end{activity}

\begin{activity}{OpenUp camp 2014}
	\entry{Type} {Talk}
	\entry{Title} {openETCS: First Implementation of the “open Proofs” Approach}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB)}
	\entry{Date}		{14-16/02/2014}
	\entry{Location}	{Nuremberg, Germany}
	\desc{The openETCS project has been presented at the business day of the OpenUp camp 2014. The focus of th presentation was on the "open proofs" concept. The OpenUp camp is an un-conference organised by the Open Source Business Foundation. The goal of the foundation is to support enterprises in deploying the strengths of Open Source, Open Innovation and Open Technology within their business models.}
	\end{activity}
	


\begin{activity}{Smart Rail Conference 2014}
	\entry{Type} {Talk}
	\entry{Title} {openETCS Tools going PolarSys: Learning from the Aviation Sector}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB), Pierre Gaufillet (Airbus)}
	\entry{Date}		{24-26/02/2014}
	\entry{Location}	{Amsterdam, Netherlands}
	\desc{The openETCS tool chain has been presented at the Smart Rail Conference. SmartRail is a global series of rail technology exhibitions and congress', that brings together over 1000 rail and metro innovators, strategic leaders, project managers and technical specialists from across the industry to drive this innovation, establish best practice and develop an efficient, reliable and competitive network.}
\end{activity}

\begin{activity}{Smart Rail Conference 2014}
	\entry{Type} {Talk}
	\entry{Title} {Developing innovation and interchangeability with openETCS}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB)}
	\entry{Date}		{24-26/02/2014}
	\entry{Location}	{Amsterdam, Netherlands}
	\desc{The openETCS project concept has been presented at the Smart Rail Conference. SmartRail is a global series of rail technology exhibitions and congress', that brings together over 1000 rail and metro innovators, strategic leaders, project managers and technical specialists from across the industry to drive this innovation, establish best practice and develop an efficient, reliable and competitive network.}
\end{activity}

\begin{activity}{Embedded World Exhibition and Conference, ITEA3 kick-off}
	\entry{Type} {Talk}
	\entry{Title} {openETCS:  European Train Control  Crossing Borders through joint Software}
	\entry{Speaker}	{Klaus-R\"{u}diger Hase (DB)}
	\entry{Date}		{26/02/2014}
	\entry{Location}	{Nuremberg, Germany}
	\desc{The ITEA 3 launch event in Germany took place at the „embedded world – Exhibition and Conference“ in Nuremberg. The event was hosted by the Federal Ministry of Education and Research (BMBF) and the ITEA Office. There, the openETCS project has been presented as an successfull example of european co-operative research.}
\end{activity}
